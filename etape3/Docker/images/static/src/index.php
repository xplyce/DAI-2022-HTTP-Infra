...
<html lang="en">
    <head>
        ...
        <meta name="une dinguerie" content="" />
        <meta name="Marko Mihajlovic, Nicolas Philipp" content="" />
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        ...
                        <h2 class="text-white-50 mx-auto mt-2
                            mb-5"> La dinguerie à l'état pur </h2>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <div class="small text-black-50">Partout</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50"><a href="#!">marko.mihajlovic@heig-vd.ch<br>nicolas.philipp@heig-vd.ch</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50">+41 00 000 00 00</div>
                            </div>
                        </div>
                    </div>
                </div>
